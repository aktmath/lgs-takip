      ...
      for (var doc in examsSnapshot.docs) {
        ...
        for (String ders in dersler) {
          if (data[ders] != null) {
            ...
            // Net hesaplamasını double olarak yap
            double net = dogru - (yanlis / 3.0);
            dersNetleri[ders] = net < 0 ? 0.0 : net;
          } else {
            dersNetleri[ders] = 0.0;
          }
        }
        ...
        double toplamNet = dersNetleri.values.reduce((a, b) => a + b);
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Net: ${net.toStringAsFixed(3)}', // 3 ondalık basamak
              style: TextStyle(
                fontWeight: FontWeight.bold,
                color: Colors.blue.shade800,
              ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Text(
                    'Toplam Net: ${exam['toplamNet'].toStringAsFixed(3)}', // 3 ondalık basamak
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                ...
                Container(
                  ...
                  child: Text(
                    'LGS: ${exam['lgsScore'].toStringAsFixed(2)}', // 2 ondalık basamak puanlar için
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
            ...
            child: Column(
              ...
              children: [
                ...
                ..._dersIsimleri.entries.map((entry) {
                  ...
                  double net = exam['dersNetleri'][dersKey] ?? 0.0;
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text(
                        'Toplam Net: ${exam['toplamNet'].toStringAsFixed(3)}',
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                              '${exams.map((e) => e['toplamNet']).reduce((a, b) => a > b ? a : b).toStringAsFixed(3)}',
                              style: TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.bold,
